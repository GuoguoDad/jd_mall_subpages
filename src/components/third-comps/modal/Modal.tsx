    ...
    return (
      <WithTheme styles={this.props.styles} themeStyles={modalStyles}>
        {styles => {
              ...
              return (
                <TouchableHighlight key={i} style={horizontalFlex} underlayColor="#ddd" onPress={onPressFn}>
                  <View style={[buttonWrapStyle, noneBorder]}>
                    <Text style={[styles.buttonText, buttonStyle]}>{button.text || `${_locale.buttonText}${i}`}</Text>
                  </View>
                </TouchableHighlight>
              )
            })
            footerDom = <View style={[btnGroupStyle, styles.footer]}>{footerButtons}</View>
          }
          ...
          return (
            <View style={styles.container}>
              <RCModal visible={visible} animationType={animType} onRequestClose={onRequestClose} onClose={onClose}>
