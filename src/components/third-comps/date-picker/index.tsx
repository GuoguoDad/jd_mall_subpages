...
export default class DatePicker extends React.Component<DatePickerProps> {
  ...
  render() {
    ...
    const locale = getComponentLocale(this.props, (this as any).context, 'DatePicker', () => require('./locale/zh_CN'))
          ...
          >
            {children &&
              ...
              React.cloneElement<object, any>(children as any, {
                extra: value ? formatProps(this.props, value) : this.props.extra || extra
              })}
          </PopupDatePicker>
        )}
      </WithTheme>
