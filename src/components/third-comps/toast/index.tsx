...
export default {
   ...
   */
  info(props: string | IToastProps, duration?: number, onClose?: () => void, mask?: boolean) {
   ...
   * @param props: toast props
   */
  success(props: string | IToastProps, duration?: number, onClose?: () => void, mask?: boolean) {
   ...
   * @param props: toast props
   */
  fail(props: string | IToastProps, duration?: number, onClose?: () => void, mask?: boolean) {
   ...
   * @param props: toast props
   */
  offline(props: string | IToastProps, duration?: number, onClose?: () => void, mask?: boolean) {
   ...
   * @param props: toast props
   */
  loading(props: string | IToastProps, duration?: number, onClose?: () => void, mask?: boolean) {
