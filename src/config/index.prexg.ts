...
export class Config implements IConfig {
  BASE_URL = 'https://lsysearchpre.cnsuning.com'
  REPORT_URL = 'https://lsyreportprexg.cnsuning.com'
  LSY_BOSS_URL = 'https://lsybossxzpre.cnsuning.com'
  CART_URL = 'https://lsycartapiprexg.cnsuning.com'
  XTCS_BASE_URL = 'https://xtcsprexg.cnsuning.com'
  SNNET_BASE_URL = 'https://10035pre.cnsuning.com'
  CMS_BASE_URL = 'https://libprexg.cnsuning.com'
  CDOSS_BASE_URL = 'http://cdosspre.cnsuning.com'
  PASSPROT_BASE_URL = 'https://passportpre.cnsuning.com'
  PASSPORT = {
    LOGIN_URL: 'https://passportprexg.cnsuning.com/ids/login',
    LOGOUT_URL: 'https://passportprexg.cnsuning.com/ids/logout',
    AUTH_STATUS_URL: 'https://loginstprexg.cnsuning.com/authStatus',
    AUTH_URL: '',
    LOGIN_THEME: 'wap_new'
  }
  RSA_PUBLIC_KEY =
...
export const ConfigPreXG = new Config()
